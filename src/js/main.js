...
// Funcion para cargar todos los assets y guardarlos en forma clave-valor
function preload() {
...
function create() {
    // Algo importante a saber, el objeto this, se refiere a la escena actual 
    ...
    // Colision entre el grupo platforms y el player
